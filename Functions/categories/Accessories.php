   ...
   <div class="col-lg-12 col-md-12 col-sm-12">
    ...
    <main style="padding-top: 100px">
      ...
      <span class = "col-lg-2 col-md-12">
        <div class="container">
          <br>
          <h2 class="text=center">Accesories </h2>
          <?php
    ...
    $view_query = "SELECT * FROM products WHERE category='Accessories'";
            ...
            <div class = "col-lg-8 col-md-8">
              ...
              ?>
                ...
                function showRemaining()
                {
                    ...
                    document.cookie = "dista_<?php echo $counter;?> = " + distance_<?php echo $counter;?>;
