  ...
  <div class="col-lg-12 col-md-12 col-sm-12">
    ...
    <main style="padding-top: 100px">
      ...
      <span class = "col-lg-2 col-md-12">
        <div class="container">
          <br>
          <h2 class="text=center">Home Appliances </h2>
          <?php
    ...
    $view_query = "SELECT * FROM products WHERE category='Home Appliances'";
            ...
            <div class = "col-lg-8 col-md-8">
              ...
              ?>
                ...
                function showRemaining()
                {
                    ...
                    document.cookie = "disth_<?php echo $counter;?> = " + distance_<?php echo $counter;?>;
                    if (distance_<?php echo $counter;?> < 0) {
                      clearInterval( timer );
                      document.getElementById('countdown_<?php echo $counter;?>').innerHTML = 'EXPIRED!';
