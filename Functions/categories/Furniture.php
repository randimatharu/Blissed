...
<div class="col-lg-12 col-md-12 col-sm-12">
    ...
    $view_query = "SELECT * FROM products WHERE category='Furniture'";
            ...
            <div class = "col-lg-8 col-md-8">
              ...
              ?>
                ...
                function showRemaining()
                {
                    ...
                    document.cookie = "distf_<?php echo $counter;?> = " + distance_<?php echo $counter;?>;
