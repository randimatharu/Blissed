...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 06, 2019 at 09:59 PM
...
INSERT INTO `ads` (`adId`, `owner`, `image`, `endDate`, `display`) VALUES
(8, 'ThreeMonths', 'apple.jpg', '2019-01-15 00:00:00', 'Yes'),
(9, 'ThreeMonths', 'watch.jpg', '2019-01-12 00:00:00', 'Yes'),
(10, 'ThreeMonths', 'jewel.jpg', '2019-01-17 00:00:00', 'Yes');
...
INSERT INTO `autobid` (`proID`, `value`, `wuser`) VALUES
(42, '450000', 'Akila Gamage');
...
(336, 'Null', 'Null Someone Bid higher than your Bid price12100 on product Leather Chair! , You Can Bid Again This Product ', 'No', 38),
(337, 'Null', 'Null Someone Bid higher than your Bid price12200 on product Leather Chair! , You Can Bid Again This Product ', 'No', 38),
(339, 'Null', 'Null Someone Bid higher than your Bid price12300 on product Leather Chair! , You Can Bid Again This Product ', 'No', 38),
(340, 'Null', 'Null Someone Bid higher than your Bid price12400 on product Leather Chair! , You Can Bid Again This Product ', 'No', 38),
(343, 'Akila Gamage', 'Akila Gamage Your product got a bid', 'No', 43),
(344, 'Akila Gamage', 'OneMonth Some on bid higher than you BID AGAIN', 'No', 43),
(345, 'Akila Gamage', 'Valid Some on bid higher than you BID AGAIN', 'No', 43),
(348, 'ThreeMonths', 'ThreeMonths Some on bid higher than you BID AGAIN', 'No', 43),
(353, 'Valid', 'Valid Some one exceed you higher price BID AGAIN', 'No', 43),
(354, 'OneMonth', 'OneMonth Some one bid higher than you BID AGAIN', 'No', 43);
...
(42, 'msi', 'TITAN', 'Laptops', 'OneMonth', 400100, 'nvidia geforce 1070', 'No', 1, '2019-01-06 00:00:00', '2019-01-08 00:00:00', 'Akila Gamage', 'msi.png'),
(44, 'Harry Potter', '', 'Books', 'ThreeMonths', 12000, 'All books are included', 'No', 1, '2019-01-07 00:00:00', '2019-01-10 00:00:00', 'Null', 'hp.jpg');
...
(35, 'Admin 4', 'admin4@gmail.com', '77f54f48f8cca148f6ed8ae478bb8a77', '123456789', 'Colombo', 'Admin', 'Active');
...
--
ALTER TABLE `ads`
  ADD CONSTRAINT `ads_ibfk_1` FOREIGN KEY (`owner`) REFERENCES `users` (`username`) ON DELETE CASCADE;

--
-- Constraints for table `autobid`
--
ALTER TABLE `autobid`
  ADD CONSTRAINT `autobid_ibfk_1` FOREIGN KEY (`proID`) REFERENCES `products` (`productID`) ON DELETE CASCADE;
