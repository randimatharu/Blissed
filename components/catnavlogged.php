        ...
        <ul class="navbar-nav mr-auto">
          ...
          <div class = "dropdown">
              ...
              <div class = "dropdown-content">
                <a href = "Mobile Phones.php?logged">Mobile Phones</a>
                <a href = "Laptops.php?logged">Laptops</a>
                <a href = "Clothes.php?logged">Clothes</a>
                <a href = "Accessories.php?logged">Accesories</a>
                <a href = "Home Appliances.php?logged">Home Appliances</a>
                <a href = "Furniture.php?logged">Furniture</a>
                <a href = "Books.php?logged">Books</a>
              </div>
            </div>
          </li>
          <li class="nav-item">
