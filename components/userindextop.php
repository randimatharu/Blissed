...
<nav class="navbar fixed-top navbar-expand-lg navbar-light white scrolling-navbar">
    ...
    <div class="container">
      ...
      </button> //podi unama navigation button tika ganna
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
       ...
       <i class="fa fa-search rounded-circle" aria-hidden="false"></i>
        ...
        <ul class="navbar-nav nav-flex-icons">
          <li class="nav-item">
          <?php
           if($_SESSION['subtype']!= 'Admin'){
            echo '<a class = "nav-link waves-effect" href = "./Functions/users/userhome.php?user='.$_SESSION['id'].'&subtype='.$_SESSION['subtype'].'"> '.$_SESSION['username'].'</a>';}
           else{
            echo '<a class = "nav-link waves-effect" href = "./Functions/Admin/Admin.php?user='.$_SESSION['id'].'&subtype='.$_SESSION['subtype'].'"> '.$_SESSION['username'].'</a>';
            } 
            ?>
          </li>
          <li class="nav-item">
            <a class = "nav-link waves-effect" href ="./Functions/main/logout.php?logout">Log Out</a>
          </li>
        </ul>
