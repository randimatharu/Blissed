...
<div id="mySidenav" class="sidenav">
  ...
  <?php
    ...
    echo '<a href = "../../Functions/users/right_to_match_cards.php?user='.$_SESSION['id'].'&name='.$_SESSION['username'].'"> Right to Match Cards </a>';
    echo '<a href = "../../Functions/users/postad.php?user='.$_SESSION['id'].'&name='.$_SESSION['username'].'"> Post Ad </a>';
    echo '<a href = "../../Functions/users/Myads.php?user='.$_SESSION['id'].'&name='.$_SESSION['username'].'"> My Ads </a>';?>
</div>
